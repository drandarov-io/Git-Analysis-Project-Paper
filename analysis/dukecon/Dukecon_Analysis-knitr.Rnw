...
Wissensmanagement \\
\large Project work \\
\large Analysis of a Repository on GitHub with Neo4j}
\author{%
...
# Conversion from Sweave to knitr
Sweave2knitr("Dukecon_Analysis.Rnw")
...
\item M Modified
\item R Renamed
\item T have their type (mode) changed
\item U Unmerged
\item X Unknown
\item B have had their pairing Broken
\end{enumerate}


\subsection{Change Count by Modification Kind}
<<echo=FALSE, fig.width=4.5, fig.height=4.5, fig.pos='ht', fig.align='center', fig.show='asis'>>=
# Load
...
\subsection{Change Count by Author}

Figute X

\begin{figure}[ht]
\centering
<<echo=FALSE, fig.width=5, fig.height=5, fig.show='asis'>>=
# Load
...
\subsection{Change Count by Time}
\subsubsection{Change Count by Month}
...
\subsubsection{Change Count by Author and Month}
...
\subsection{Change Count by File Type}
\subsubsection{Change Count by File Type}
...
\subsubsection{Change Count by File Type and Author}
...
\subsection{Ownership of Repository}
\subsubsection{Ownership of Repository by File Type}
...
\subsubsection{Ownership of Repository by Package}

\begin{figure}[ht]
\centering
<<echo=FALSE, fig.width=10, fig.height=15>>=
# Load data
...
\subsubsection{Ownership of Repository by File}

\begin{figure}[ht]
\centering
<<echo=FALSE, fig.width=10, fig.height=15, fig.show='asis'>>=
# Load csv file #
