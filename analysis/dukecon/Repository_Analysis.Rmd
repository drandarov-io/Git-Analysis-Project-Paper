...
1. Fügen Sie das jQAssistant-Plugin in die pom.xml Ihres Maven-Projekts ein
``` xml
<build>
    <plugins>
        <plugin>
...
2. Führen Sie folgende Maven-Befehle aus:
```
mvn install
mvn jqassistant:server
```

3. Öffnen Sie http://localhost:7474 in Ihrem Browser zum Zugriff auf die Neo4j Datenbank

4. Führen Sie nach belieben Cypher-Queries aus. Die Ergebnisse lassen sich als csv-Dateien exportieren und z.B. mit R analysieren
