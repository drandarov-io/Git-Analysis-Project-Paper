...
In diesem Projekt sind es hauptsächlich Java, Groovy (eine alternative JVM-Sprache) und XL, wobei groovy doppelt so oft geändert wurde wie java und java doppelt so oft geändert wurde wie xml. HTML kommt, obwohl es eine Web-Applikation ist, kaum vor. 
