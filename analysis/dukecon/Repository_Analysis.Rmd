...
- R-Code:
```{r commit-massage-by-most-used-words, fig.width=10, fig.height=10, warning=FALSE}
# # Load data
...
Alexander Schwartz hingegen konzentriert sich offenbar auf organisatorische Aufgaben im Repository, wie verschiedene Braches mergen, da häufig die Wörter "develop" und "merge" fallen.
