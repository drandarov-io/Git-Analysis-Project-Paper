...
5. R und RStudio
    ...
    - Als Einstieg kann gerne dieses Repository heruntergeladen werden und die Repository_Analysis.Rmd in (Git-Repository-Analysis\analysis\hacktalk) geöffnet werden.
...
- R-Code:
```{r change-count-by-modification-kinds, fig.width=7.5, fig.height=7.5, warning=FALSE}
# # Load data
...
- R-Code:
```{r change-count-by-modification-kinds-and-authors, fig.width=10, fig.height=10, warning=FALSE}
# # Load data
...
- R-Code:
```{r change-count-by-months, fig.width=10, fig.height=10, warning=FALSE}
# # Load data
...
- R-Code:
```{r change-counts-of-authors-by-file-types, fig.width=10, fig.height=10, warning=FALSE}
# # Load data
...
- R-Code:
```{r commit-message-by-most-used-words-by-file-types, fig.width=10, fig.height=5, warning=FALSE}
# # Load data
...
- R-Code:
```{r commit-message-by-most-used-words-by-authors, fig.width=10, fig.height=5, warning=FALSE}
# # Load data
